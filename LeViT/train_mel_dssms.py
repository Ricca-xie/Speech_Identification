...
def parse_config():
    ...
    parser.add_argument('--checkpoint_path', type=str, default='checkpoints/levit384_mel_single_')
...
def valid(model):
    print('Validating...')
    test_data_dir = '../datasets/concat-I/mel/X_test_mel.myarray'
    test_label_dir = '../datasets/concat-I/mel/Y_test_mel.myarray'
    ...
    #                          batch_size=16,
    #                          is_training=False)
    # dev_data = data_loader('../../speech_identify/code/preprocess/concate/mel', 'X_test_mel.myarray', 'Y_test_mel.myarray', (13755, 3, 1, 300, 64), (13755, 1251), batch_size=16, is_shuffle=False)
    dataset_dev = SpeechDataset(data_path=test_data_dir, label_path=test_label_dir,data_length = 8251, filters=64)
...
def train(args):
    ...
    train_data_dir = '../datasets/concat-I/mel//X_train_mel.myarray'
    train_label_dir = '../datasets/concat-I/mel//Y_train_mel.myarray'
    ...
    dataset_train = SpeechDataset(data_path=train_data_dir, label_path=train_label_dir, data_length = 145262, filters = 64)
    ...
    for epoch in range(args.epochs):
        model.train()
        # train_data = data_loader('../../speech_identify/code/preprocess/concate/mel', 'X_train_mel.myarray', 'Y_train_mel.myarray', (125995, 3, 1, 300, 64), (125995, 1251), batch_size=args.batchsize, type = 'mel' ,is_append = True, is_shuffle=True)
        train_data = create_loader( dataset_train, batch_size = args.batchsize, is_training=True)
        acc1_total = 0.
        acc5_total = 0.
        loss_total = 0.
