...
specification = {
    ...
    'LeViT_384_multi': {
        'C': '384_512_768', 'D': 32, 'N': '6_9_12', 'X': '4_4_4', 'drop_path': 0.1, 'input_chan':3,
        'weights': 'https://dl.fbaipublicfiles.com/LeViT/LeViT-384-9bdaf2e2.pth'},
    'LeViT_384_sin': {
        'C': '384_512_768', 'D': 32, 'N': '6_9_12', 'X': '4_4_4', 'drop_path': 0.1, 'input_chan':1,
        'weights': 'https://dl.fbaipublicfiles.com/LeViT/LeViT-384-9bdaf2e2.pth'},
}
...
@register_model
def LeViT_384_multi(num_classes=1000, distillation=True,
              pretrained=False, fuse=False):
    # import pdb;pdb.set_trace()
    return model_factory(**specification['LeViT_384_multi'], num_classes=num_classes,
                         distillation=distillation, pretrained=pretrained, fuse=fuse)


@register_model
def LeViT_384_sin(num_classes=1000, distillation=True,
              pretrained=False, fuse=False):
    return model_factory(**specification['LeViT_384_sin'], num_classes=num_classes,
                         distillation=distillation, pretrained=pretrained, fuse=fuse)
...
def b16(n, activation,input_chan,resolution=224):
    return torch.nn.Sequential(
        Conv2d_BN(input_chan, n // 8, 3, 2, 1, resolution=resolution),
        activation(),
...
def model_factory(C, D, X, N, drop_path,input_chan, weights,
    ...
    model = LeViT(
        ...
        mlp_activation=act,
        hybrid_backbone=b16(embed_dim[0], activation=act, input_chan = input_chan),
